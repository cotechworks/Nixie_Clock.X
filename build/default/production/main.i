...
{
    if(DisplayCnt == 0){
        if(DisplayNum == 0) do { LATAbits.LATA4 = 1; } while(0);
        else if(DisplayNum == 1) do { LATAbits.LATA6 = 1; } while(0);
        else if(DisplayNum == 2) do { LATAbits.LATA7 = 1; } while(0);
        else if(DisplayNum == 3) do { LATBbits.LATB0 = 1; } while(0);
        else if(DisplayNum == 4) do { LATBbits.LATB2 = 1; } while(0);
        else if(DisplayNum == 5) do { LATBbits.LATB5 = 1; } while(0);
    }else if(DisplayCnt == 30){
        ...
        if((DisplayVal[DisplayNum] & 0b0001) != 0) do { LATAbits.LATA1 = 1; } while(0);
        else do { LATAbits.LATA1 = 0; } while(0);

        if((DisplayVal[DisplayNum] & 0b0010) != 0) do { LATAbits.LATA0 = 1; } while(0);
        else do { LATAbits.LATA0 = 0; } while(0);

        if((DisplayVal[DisplayNum] & 0b0100) != 0) do { LATAbits.LATA3 = 1; } while(0);
        else do { LATAbits.LATA3 = 0; } while(0);

        if((DisplayVal[DisplayNum] & 0b1000) != 0) do { LATAbits.LATA2 = 1; } while(0);
